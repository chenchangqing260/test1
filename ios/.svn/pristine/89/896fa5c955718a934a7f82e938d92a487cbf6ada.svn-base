...
-(instancetype)initWithFrame:(CGRect)frame andLineChartType:(JHLineChartType)lineChartType{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        _xNumberColor = [UIColor darkGrayColor];
        _yNumberColor = [UIColor darkGrayColor];
...
-(void)setValueArr:(NSArray *)valueArr{
    ...
    if (self.customYLineDataArr) {
        if (_yLineDataArr && _yLineDataArr.count > 0) {
            return;
        }else{
            [self updateYScale];
        }
        ...
        case JHLineChartQuadrantTypeFirstQuardrant:{
            ...
            if (_xLineDataArr.count>0) {
                ...
                for (NSInteger i = 0; i<_xLineDataArr.count;i++ ) {
                    ...
                    [self drawText:[NSString stringWithFormat:@"%@",_xLineDataArr[i]] andContext:context atPoint:P_M(p.x-len/2, p.y+2) WithColor:_xNumberColor andFontSize:self.xDescTextFontSize];
                }
            ...
            if (_yLineDataArr.count>0) {
                ...
                for (NSInteger i = 0; i<_yLineDataArr.count; i++) {
                    ...
                    if (_showYLevelLine) {
                        ...
                        CGFloat markW = 0;//_showYLineMark ? 3 :0;
                        [self drawLineWithContext:context andStarPoint:p andEndPoint:P_M(p.x+markW, p.y) andIsDottedLine:NO andColor:_xAndYLineColor];
                    }
                    [self drawText:[NSString stringWithFormat:@"%@",_yLineDataArr[i]] andContext:context atPoint:P_M(p.x-len-3, p.y-hei / 2) WithColor:_yNumberColor andFontSize:self.yDescTextFontSize];
                }
            }
        ...
        case JHLineChartQuadrantTypeFirstAndSecondQuardrant:{
            ...
            if (_xLineDataArr.count == 2) {
                ...
                for (NSInteger i = 0; i<rightArr.count;i++ ) {
                    ...
                    [self drawText:[NSString stringWithFormat:@"%@",rightArr[i]] andContext:context atPoint:P_M(p.x-len/2, p.y+2) WithColor:_xNumberColor andFontSize:self.xDescTextFontSize];
                }
                ...
                for (NSInteger i = 0; i<leftArr.count;i++ ) {
                    ...
                    [self drawText:[NSString stringWithFormat:@"%@",leftArr[leftArr.count-1-i]] andContext:context atPoint:P_M(p.x-len/2, p.y+2) WithColor:_xNumberColor andFontSize:self.xDescTextFontSize];
                }
            ...
            if (_yLineDataArr.count == 2) {
                ...
                for (NSInteger i = 0; i<topArr.count; i++) {
                    ...
                    if (_showYLevelLine) {
                        ...
                        [self drawLineWithContext:context andStarPoint:p andEndPoint:P_M(p.x+3, p.y) andIsDottedLine:NO andColor:_xAndYLineColor];
                    [self drawText:[NSString stringWithFormat:@"%@",topArr[i]] andContext:context atPoint:P_M(p.x-len-3, p.y-hei / 2) WithColor:_yNumberColor andFontSize:self.yDescTextFontSize];
                ...
                for (NSInteger i = 0; i<bottomArr.count; i++) {
                    ...
                    [self drawText:[NSString stringWithFormat:@"%@",bottomArr[i]] andContext:context atPoint:P_M(p.x-len-3, p.y-hei / 2) WithColor:_yNumberColor andFontSize:self.yDescTextFontSize];
                }
...
- (void)drawPositionLineWithContext:(CGContextRef)context{
    ...
    for (NSInteger m = 0;m<_valueArr.count;m++) {
        ...
        for (NSInteger i = 0 ;i<arr.count;i++ ) {
            ...
            if (p.y!=0) {
                UIColor *pointNumberColor = [UIColor colorWithHex:0x33cfda];
                if (_pointNumberColorArr && _pointNumberColorArr.count > 0) {
                    pointNumberColor = [_pointNumberColorArr objectAtIndex:0];
                }
                //(_pointNumberColorArr.count == _valueArr.count?(_pointNumberColorArr[m]):([UIColor orangeColor]));
                ...
                switch (_lineChartQuadrantType) {
                    ...
                    case JHLineChartQuadrantTypeFirstQuardrant:
                    {
                        ...
                        [self drawText:aimStr andContext:context atPoint:P_M(p.x - length / 2, p.y - size.height / 2 -15) WithColor:pointNumberColor andFontSize:self.valueFontSize];
                    }
                        break;
                    case JHLineChartQuadrantTypeFirstAndSecondQuardrant:
                    {
