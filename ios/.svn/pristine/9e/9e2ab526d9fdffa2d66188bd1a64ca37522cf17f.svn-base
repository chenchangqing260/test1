...
-(void)customNavigationBar{
    ...
    //2、设置导航栏背景色和去除底部横线
    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithHex:0x26292E] size:CGSizeMake(kSCREEN_WIDTH, 1)] forBarPosition:UIBarPositionAny barMetrics:UIBarMetricsDefault];
