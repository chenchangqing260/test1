//
//  QuesMainItemCollectionViewCell.m
//  ScienceChina
//
...
@interface QuesMainItemCollectionViewCell()
...
@implementation QuesMainItemCollectionViewCell
...
+(NSString*)ID{
    return @"QuesMainItemCollectionViewCell";
}

+(QuesMainItemCollectionViewCell *)newCell{
    return [[NSBundle mainBundle]loadNibNamed:@"QuesMainItemCollectionViewCell" owner:nil options:nil][0];
}
