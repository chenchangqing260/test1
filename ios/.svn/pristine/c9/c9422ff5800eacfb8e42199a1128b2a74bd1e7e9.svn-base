...
-(void)loadeData{
    ...
    [[WebAccessManager sharedInstance]getInfoListByCategoryId:self.category.at_id page:_page showSlide:@"0" completion:^(WebResponse *response, NSError *error) {
