//
//  ActivityNormalInfoTableViewCell.m
//  ScienceChina
//
...
@interface ActivityNormalInfoTableViewCell()
...
@implementation ActivityNormalInfoTableViewCell
...
+(ActivityNormalInfoTableViewCell *)newCell{
    return [[NSBundle mainBundle]loadNibNamed:@"ActivityNormalInfoTableViewCell" owner:nil options:nil][0];
}

+(NSString*)ID{
    return @"ActivityNormalInfoTableViewCell";
}
