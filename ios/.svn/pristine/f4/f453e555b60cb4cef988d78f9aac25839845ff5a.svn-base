...
-(id)initWithFrame:(CGRect)frame normalImage:(UIImage*)passiveImage andPressedImage:(UIImage*)activeImage withScrollview:(UIScrollView*)scrView
{
    ...
    if (self)
    {
        ...
        _menuTable = [[UITableView alloc]initWithFrame:CGRectMake(SCREEN_WIDTH/10 * 7, 0, 0.3*SCREEN_WIDTH,SCREEN_HEIGHT - (SCREEN_HEIGHT - CGRectGetMaxY(self.frame)) )];
...
//    UIVisualEffectView *vsview = [[UIVisualEffectView alloc]initWithEffect:blur];
    ...
    _bgView.backgroundColor = [UIColor colorWithHex:0x000000 alpha:0.3];// UPDATE ELLISON
    _bgView.alpha = 0;
