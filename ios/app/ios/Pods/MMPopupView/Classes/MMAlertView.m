                 ...
                 inputHandler:(MMPopupInputHandler)inputHandler
{
    ...
    if ( self )
    {
        ...
        self.topLabel.frame = CGRectMake(-1,-1, [UIScreen mainScreen].bounds.size.width+5, 9);
        
        [self.topLabel setBackgroundColor:[UIColor colorWithRed:37.0f/255.0f green:171.0f/255.0f blue:224.0f/255.0f alpha:1]];
        
        lastAttribute = self.topLabel.mas_bottom;
        ...
        for ( NSInteger i = 0 ; i < items.count; ++i )
        {
            ...
            [btn setTitleColor:item.highlight?config.titleColor:config.itemNormalColor forState:UIControlStateNormal];
