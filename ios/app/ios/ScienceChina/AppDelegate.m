...
@interface AppDelegate ()<WXApiDelegate,QQApiInterfaceDelegate,WeiboSDKDelegate,EAIntroDelegate,CoreStatusProtocol>
...
-(void)coreNetworkChangeNoti:(NSNotification *)noti{
    ...
    //网络变化时有网络，开始进行通知刷新数据
     if([CoreStatus isNetworkEnable]){
        [[NSNotificationCenter defaultCenter]postNotificationName:kNOTOICE_REFRESHINDEXVIEW_INFO object:nil];
