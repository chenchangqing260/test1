...
//    [[NSString stringWithFormat:@"%@",text] drawAtPoint:rect withAttributes:@{NSFontAttributeName:font,NSForegroundColorAttributeName:color}];
    ...
    if ([text hasPrefix:@"image:"]) {
        UIImage *image = [UIImage imageNamed:[text substringFromIndex:6]];
        
//        CGRect imageRect = CGRectMake(rect.origin.x + (rect.size.width-image.size.width/2.0)/2.0,
//                                      rect.origin.y + (rect.size.height-image.size.height/2.0)/2.0,
//                                      image.size.width/2.0, image.size.height/2.0);
//        CGRect imageRect = CGRectMake(rect.origin.x + (rect.size.width-image.size.width)/2.0,
//                                      rect.origin.y + (rect.size.height-image.size.height)/2.0,
