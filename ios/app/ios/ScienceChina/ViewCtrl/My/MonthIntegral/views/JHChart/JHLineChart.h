...
/**
 *  是否自定义Y轴的数据yLineDataArr，默认为NO
 *  YES : yLineDataArr 的值才生效,用户自定义Y轴间距
 *  NO  : yLineDataArr 的值不生效
 */
@property (assign,  nonatomic) BOOL customYLineDataArr;
/**
...
@property (nonatomic, strong) UIColor * xNumberColor;

@property (nonatomic, strong) UIColor * yNumberColor;
...
/**
 *  是否显示Y轴的刻度(小横向)Default is YES
 */
@property (nonatomic,assign) BOOL showYLineMark;
